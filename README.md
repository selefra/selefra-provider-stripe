# Selefra Provider Stripe

Use this repo as a raw reference to **tables and schema** for Stripe resources. [Here's](https://github.com/selefra/selefra-provider-stripe/blob/main/docs/tables/stripe.md) a summary of full coverage.
